                               ...
                               <div style=""background-color: #4f85f6; color: white; text-align: center; padding: 20px 0;"">
                                ...
                                <div style=""background-color: #f4f4f4; padding: 1rem 2rem;"">
                                    ...
                                    <div style=""color: #191919; font-size: 11px;"">
                                        <p>If you did not request this code, it is posible that someone else is trying to access to account<span style = 'color: #0041cd;' >{verificationRequest.Email}</ span >. This email can't receive replies.For more information, visit the silicons help center</p>
                                    </div>           
                                </div>
                                <div style=""color: #191919; font-size: 11px; text-align: center;"">
                                    <p>&copyLear23, Sveavägen 1, SE-123 45 Stockholm, Sweden</p>
                                </div>
                            </div>    
                        </body>
                       </html>                             
